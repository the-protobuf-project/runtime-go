// Package mongodb will implement the [database.Store] contract over mongodb.
//
...
// roughly Config{Client *mongo.Client, Database, Collection string} — and a New constructor that
