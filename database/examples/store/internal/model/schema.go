...
func BookResource() *store.Resource {
	return &store.Resource{
		...
		Columns: []store.Column{
			{Name: "id", Field: "id", Kind: store.KindString, SQLType: "TEXT", PrimaryKey: true, NotNull: true},
			{Name: "title", Field: "title", Kind: store.KindString, SQLType: "TEXT", Unique: true},
...
func ReadingResource() *store.Resource {
	return &store.Resource{
		...
		Columns: []store.Column{
			...
			{Name: "sensor", Field: "sensor", Kind: store.KindString, SQLType: "TEXT"},
