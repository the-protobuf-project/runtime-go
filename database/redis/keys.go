...
func (k keys) doc(id string) string { return k.prefix + "doc:" + id }
...
// deleted.
// Data type: set.
func (k keys) index() string { return k.prefix + "docs:index" }
...
// Data type: string.
func (k keys) byContent(hash string) string { return k.prefix + "docs:content:" + hash }
...
// Data type: string.
func (k keys) contentOf(id string) string { return k.prefix + "dochash:" + id }
