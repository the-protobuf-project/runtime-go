...
| [`mcp`](mcp) | `github.com/the-protobuf-project/runtime-go/mcp` | Package mcp is the runtime that protoc-gen-mcp's generated code calls into: server configuration, transport handling, and the MCP integration helpers a generated Serve*MCP function needs. |
